...
_inter_wiki_map = {
    'English': (
        ...
        ('Summon Reaper', {'link': 'Summon Reaper'}),
        ...
        ('(?:level [0-9]+) Behead', {'link': 'Behead Support'}),
        ...
        ('(?:level [0-9]+) Divine Blessing', {'link': 'Divine Blessing Support'}),
        ('(?:level [0-9]+) Earthbreaker', {'link': 'Earthbreaker Support'}),
        ...
        ('(?:level [0-9]+) Endurance Charge on Melee Stun', {'link': 'Endurance Charge on Melee Stun Support'}),
        ('(?:level [0-9]+) Enhance', {'link': 'Enhance Support'}),
        ('(?:level [0-9]+) Enlighten', {'link': 'Enlighten Support'}),
        ('(?:level [0-9]+) Elemental Damage with Attacks', {'link': 'Elemental Damage with Attacks Support'}),
        ('(?:level [0-9]+) Eternal Blessing', {'link': 'Eternal Blessing Support'}),
        ...
        ('(?:level [0-9]+) Focused Ballista', {'link': 'Focused Ballista Support'}),
        ('(?:level [0-9]+) Fork', {'link': 'Fork Support'}),
        ('(?:level [0-9]+) Fortify', {'link': 'Fortify Support'}),
        ('(?:level [0-9]+) Generosity', {'link': 'Generosity Support'}),
        ('(?:level [0-9]+) Greater Multiple Projectiles', {'link': 'Greater Multiple Projectiles Support'}),
        ...
        ('(?:level [0-9]+) Increased Critical Damage', {'link': 'Increased Critical Damage Support'}),
        ('(?:level [0-9]+) Increased Critical Strikes', {'link': 'Increased Critical Strikes Support'}),
        ...
        ('(?:level [0-9]+) Lesser Multiple Projectiles', {'link': 'Lesser Multiple Projectiles Support'}),
        ...
        ('(?:level [0-9]+) Mark on Hit', {'link': 'Mark on Hit Support'}),
        ...
        ('(?:level [0-9]+) Minion and Totem Elemental Resistance', {'link': 'Minion and Totem Elemental Resistance Support'}),
        ...
        ('(?:level [0-9]+) Physical Projectile Attack Damage', {'link': 'Physical Projectile Attack Damage Support'}),
        ...
        ('(?:level [0-9]+) Trinity', {'link': 'Trinity Support'}),
